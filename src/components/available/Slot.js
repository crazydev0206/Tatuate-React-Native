    ...
    return(
        <View style={[styles.datesMeta,{borderTopColor: colors.separator},props.style]}>
    		<View style={styles.datesMetaLeft}>
                ...
                <TextRegular style={[styles.datesMetaDetails,{color: colors.pText}]}>{translate(props.priceBased,'slot_price', { price: fomartCurrOut(props.price) } )}{translate(props.priceBased, 'slot_available', {count: parseInt(props.data.guests)} )}</TextRegular>
            </View>
